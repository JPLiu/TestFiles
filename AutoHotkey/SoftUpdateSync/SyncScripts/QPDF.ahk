...
SoftName := "QPDF"
ZipFileName := "qpdf-*-msvc32.zip"
SoftPath := DefaultPath . "\0-CommandLineTools\QPDF\QPDF-MSVC32"
SoftNameZip := SoftName . ".zip"
ExtPath := DownloadPath . SoftName
LnkName := "QPDF"
LnkPath := DefaultPath . "\0-CommandLineTools\QPDF"
