...
SoftName := "MinGit"
ZipFileName := "MinGit-*-32-bit.zip"
SoftPath := DefaultPath . "\0-CommandLineTools\MinGit-BusyBox"
SoftNameZip := SoftName . ".zip"
ExtPath := DownloadPath . SoftName
LnkName := "MinGit-BusyBox"
LnkPath := DefaultPath . "\0-CommandLineTools\MinGit-BusyBox"
