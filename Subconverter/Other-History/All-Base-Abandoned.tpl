# 内容来自：https://raw.githubusercontent.com/LM-Firefly/Rules/master/Subconverter-base/all-base.tpl
# 补充了 external-ui: {{ local.clash.api_externalui }}
# 2021.03.09 暂时废置
...
#external-ui: folder
external-ui: {{ local.clash.api_externalui }}
