...
SoftName := "IrfanViewLanguage"
ZipFileName := "irfanview_lang_chinese.zip"
SoftPath := DefaultPath . "\IrfanView\Languages"
SoftNameZip := SoftName . ".zip"
ExtPath := DownloadPath . SoftName
LnkName := "IrfanView"
LnkPath := DefaultPath . "\IrfanView"
...
SoftName := "IrfanViewPlugins"
ZipFileName := "iview*_plugins.zip"
SoftPath := DefaultPath . "\IrfanView\Plugins"
SoftNameZip := SoftName . ".zip"
ExtPath := DownloadPath . SoftName
LnkName := "IrfanView"
LnkPath := DefaultPath . "\IrfanView"
...
SoftName := "IrfanView"
ZipFileName := "iview*.zip"
SoftPath := DefaultPath . "\IrfanView"
SoftNameZip := SoftName . ".zip"
ExtPath := DownloadPath . SoftName
LnkName := "IrfanView"
LnkPath := DefaultPath . "\IrfanView"
